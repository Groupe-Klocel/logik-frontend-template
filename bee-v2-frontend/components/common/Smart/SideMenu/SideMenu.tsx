			...
			<Menu theme={theme} mode="inline">
				...
				<SubMenu key="configuration" icon={<SettingOutlined />} title={t("configuration")}>
					...
					<SubMenu key="configuration-cartography" title={t("cartography")}>
						<Menu.Item key="configuration-cartography-blocs"><Link href='/blocs'>{t("blocs")}</Link></Menu.Item>
						<Menu.Item key="configuration-cartography-locations"><Link href='/locations'>{t("locations")}</Link></Menu.Item>
					</SubMenu>
					...
					<SubMenu key="configuration-articles" title={t("articles")}>
						<SubMenu key="configuration-articles-features" title={t("features")}>
							<Menu.Item key="configuration-articles-features-codes"><Link href='/features-codes'>{t("features-codes")}</Link></Menu.Item>
							<Menu.Item key="configuration-articles-features-types"><Link href='/features-types'>{t("features-types")}</Link></Menu.Item>
						</SubMenu>
						<Menu.Item key="configuration-articles-articles">	<Link href='/articles'>{t("articles")}</Link></Menu.Item>
						<Menu.Item key="configuration-articles-barcodes">	<Link href='/barcodes'>{t("barcodes")}</Link></Menu.Item>
						<Menu.Item key="configuration-articles-blacklisted-barcodes">	<Link href='/blacklisted-barcodes'>{t("blacklisted-barcodes")}</Link></Menu.Item>
						<Menu.Item key="configuration-articles-sets">	<Link href='/sets'>{t("sets")}</Link></Menu.Item>
					</SubMenu>
					...
					<Menu.Item key="configuration-returns-codes">
						<Link href='/returns-codes'>{t("returns-codes")}</Link>
					</Menu.Item>
				</SubMenu>

				<SubMenu icon={<ApartmentOutlined />} key="stock-management" title={t("stock-management")}>
					...
					<SubMenu key="stock-management-cycle-counts" title={t("cycle-counts")}>
						<Menu.Item key="stock-management-cycle-counts-cyle-counts"><Link href='/cycle-counts'>{t("cycle-counts")}</Link></Menu.Item>
						<Menu.Item key="stock-management-cycle-counts-recommended"><Link href='/recommended'>{t("recommended")}</Link></Menu.Item>
					</SubMenu>
				</SubMenu>

				<SubMenu icon={<HourglassOutlined />} key="preparation-management" title={t("preparation-management")}>
					<Menu.Item key="preparation-management-deliveries"><Link href='/deliveries'>{t("deliveries")}</Link></Menu.Item>
					<Menu.Item key="preparation-management-boxes"><Link href='/boxes'>{t("boxes")}</Link></Menu.Item>
					<Menu.Item key="preparation-management-rounds"><Link href='/rounds'>{t("rounds")}</Link></Menu.Item>
					<Menu.Item key="preparation-management-box-checking"><Link href='/box-checking'>{t("box-checking")}</Link></Menu.Item>
					<Menu.Item key="preparation-management-manual-recubing"><Link href='/manual-recubing'>{t("manual-recubing")}</Link></Menu.Item>
					<Menu.Item key="preparation-management-loads"><Link href='/loads'>{t("loads")}</Link></Menu.Item>
				</SubMenu>

				<SubMenu icon={<SlidersOutlined />} key="monitoring" title={t("monitoring")}>
					<Menu.Item key="monitoring-dashboard"><Link href='/dashboard'>{t("dashboard")}</Link></Menu.Item>
					<Menu.Item key="monitoring-warnings"><Link href='/warning'>{t("warning")}</Link></Menu.Item>
					<Menu.Item key="monitoring-status-evolutions"><Link href='/status-evolutions'>{t("status-evolutions")}</Link></Menu.Item>
				</SubMenu>
