...
import { Form, InputNumber, Button, Select, Row , Col , Checkbox} from 'antd';
...
export const AddMovementsConfigForm: FC<IAddMovementsConfigFormProps> = ({ }: IAddMovementsConfigFormProps) => {
		...
		<WrapperForm>
			...
			>
				...
				<Form.Item
					...
					name="movement-code" 
					hasFeedback
					rules={[{ required: true, message: `${t('error-message-select-1')} ${t('movement-code')}`}]}
				>
