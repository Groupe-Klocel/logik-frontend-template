...
import { DEFAULT_ITEMS_PER_PAGE, DEFAULT_PAGE_NUMBER, useBarcodes, pathParams, showError , DataQueryType, PaginationType} from '@helpers';
...
const BarcodesList =  ({ searchCriteria }: IBarcodesListProps) => {
	...
	const { isLoading, data, error } = useBarcodes(searchCriteria, pagination.current, pagination.itemsPerPage, "id")
