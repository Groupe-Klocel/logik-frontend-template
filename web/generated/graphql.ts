...
export type GetAllBarcodesQuery = { __typename?: 'Query', barcodes: { __typename?: 'BarcodeListResult', count: number, itemsPerPage: number, totalPages: number, results: Array<{ __typename?: 'Barcode', id?: string | null, name?: string | null, supplierName?: string | null, supplierArticleCode?: string | null, blacklisted?: boolean | null, rotation?: number | null, preparationMode?: number | null, rotationText?: string | null, preparationModeText?: string | null, stockOwnerId?: string | null, stockOwner: { __typename?: 'StockOwner', name?: string | null } }> } };
...
export type GetBarcodeByIdQuery = { __typename?: 'Query', barcode?: { __typename?: 'Barcode', id?: string | null, name?: string | null, supplierName?: string | null, supplierArticleCode?: string | null, rotation?: number | null, preparationMode?: number | null, blacklisted?: boolean | null, stockOwnerId?: string | null, rotationText?: string | null, preparationModeText?: string | null, stockOwner: { __typename?: 'StockOwner', name?: string | null } } | null };

export type GetArticleLuBarcodeByBarcodeIdQueryVariables = Exact<{
  id: Scalars['String'];
}>;


export type GetArticleLuBarcodeByBarcodeIdQuery = { __typename?: 'Query', articleLuBarcodesByBarcodeId: Array<{ __typename?: 'ArticleLuBarcode', id?: string | null, articleId?: string | null, stockOwnerId?: string | null, luId?: string | null, article: { __typename?: 'Article', name?: string | null, code?: string | null, supplierName?: string | null, length?: number | null, width?: number | null, height?: number | null, baseUnitWeight?: number | null }, lu: { __typename?: 'LogisticUnit', name?: string | null } }> };
...
export type CreateBarcodeMutation = { __typename?: 'Mutation', createBarcode: { __typename?: 'Barcode', id?: string | null, name?: string | null, supplierName?: string | null, supplierArticleCode?: string | null, rotation?: number | null, preparationMode?: number | null, blacklisted?: boolean | null, stockOwnerId?: string | null, rotationText?: string | null, preparationModeText?: string | null } };
...
export type ExportBarcodesMutationVariables = Exact<{
  format?: InputMaybe<ExportFormat>;
  compression?: InputMaybe<ExportCompression>;
  separator?: InputMaybe<Scalars['String']>;
  orderBy?: InputMaybe<Array<BarcodeOrderByCriterion> | BarcodeOrderByCriterion>;
...
export type ExportBarcodesMutation = { __typename?: 'Mutation', exportBarcodes: { __typename?: 'ExportResult', url: string } };
...
export type UpdateBarcodeMutation = { __typename?: 'Mutation', updateBarcode?: { __typename?: 'Barcode', id?: string | null, name?: string | null, supplierName?: string | null, supplierArticleCode?: string | null, rotation?: number | null, preparationMode?: number | null, blacklisted?: boolean | null, stockOwnerId?: string | null, rotationText?: string | null, preparationModeText?: string | null } | null };

export type GetBarcodesRotationsParamsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetBarcodesRotationsParamsQuery = { __typename?: 'Query', listParametersForAScope: Array<{ __typename?: 'ParameterResults', id: string, scope: string, code: string, text: string }> };

export type GetBarcodesPreparationModesParamsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetBarcodesPreparationModesParamsQuery = { __typename?: 'Query', listParametersForAScope: Array<{ __typename?: 'ParameterResults', id: string, scope: string, code: string, text: string }> };
...
export type SimpleGetAllArticlesLusBarcodesQueryVariables = Exact<{ [key: string]: never; }>;


export type SimpleGetAllArticlesLusBarcodesQuery = { __typename?: 'Query', stockOwners: { __typename?: 'StockOwnerListResult', results: Array<{ __typename?: 'StockOwner', id?: string | null, name?: string | null }> } };

export type SimpleGetAllArticlesLusQueryVariables = Exact<{ [key: string]: never; }>;


export type SimpleGetAllArticlesLusQuery = { __typename?: 'Query', articleLus: { __typename?: 'ArticleLuListResult', results: Array<{ __typename?: 'ArticleLu', article: { __typename?: 'Article', id?: string | null, name?: string | null }, lu: { __typename?: 'LogisticUnit', id?: string | null, name?: string | null } }> } };
...
export const GetAllBarcodesDocument = `
    query GetAllBarcodes($filters: BarcodeSearchFilters, $orderBy: [BarcodeOrderByCriterion!], $page: Int!, $itemsPerPage: Int!, $language: String) {
  barcodes(
    filters: $filters
    orderBy: $orderBy
    page: $page
...
export const GetArticleLuBarcodeByBarcodeIdDocument = `
  ...
  articleLuBarcodesByBarcodeId(barcodeId: $id) {
    ...
    `;
export const useGetArticleLuBarcodeByBarcodeIdQuery = <
      TData = GetArticleLuBarcodeByBarcodeIdQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables: GetArticleLuBarcodeByBarcodeIdQueryVariables,
      options?: UseQueryOptions<GetArticleLuBarcodeByBarcodeIdQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<GetArticleLuBarcodeByBarcodeIdQuery, TError, TData>(
      ['GetArticleLuBarcodeByBarcodeId', variables],
      fetcher<GetArticleLuBarcodeByBarcodeIdQuery, GetArticleLuBarcodeByBarcodeIdQueryVariables>(client, GetArticleLuBarcodeByBarcodeIdDocument, variables, headers),
      options
    );
...
export const ExportBarcodesDocument = `
    mutation ExportBarcodes($format: ExportFormat, $compression: ExportCompression, $separator: String, $orderBy: [BarcodeOrderByCriterion!], $filters: BarcodeExportFilters) {
  exportBarcodes(
    format: $format
    compression: $compression
    separator: $separator
    ...
    `;
export const useExportBarcodesMutation = <
      TError = unknown,
      TContext = unknown
    >(
      client: GraphQLClient,
      options?: UseMutationOptions<ExportBarcodesMutation, TError, ExportBarcodesMutationVariables, TContext>,
      headers?: RequestInit['headers']
    ) =>
    useMutation<ExportBarcodesMutation, TError, ExportBarcodesMutationVariables, TContext>(
      ['ExportBarcodes'],
      (variables?: ExportBarcodesMutationVariables) => fetcher<ExportBarcodesMutation, ExportBarcodesMutationVariables>(client, ExportBarcodesDocument, variables, headers)(),
      options
    );
...
export const GetBarcodesRotationsParamsDocument = `
  ...
  listParametersForAScope(scope: "rotation") {
    ...
    `;
export const useGetBarcodesRotationsParamsQuery = <
      TData = GetBarcodesRotationsParamsQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables?: GetBarcodesRotationsParamsQueryVariables,
      options?: UseQueryOptions<GetBarcodesRotationsParamsQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<GetBarcodesRotationsParamsQuery, TError, TData>(
      variables === undefined ? ['getBarcodesRotationsParams'] : ['getBarcodesRotationsParams', variables],
      fetcher<GetBarcodesRotationsParamsQuery, GetBarcodesRotationsParamsQueryVariables>(client, GetBarcodesRotationsParamsDocument, variables, headers),
      options
    );
export const GetBarcodesPreparationModesParamsDocument = `
  ...
  listParametersForAScope(scope: "preparation_mode") {
    ...
    `;
export const useGetBarcodesPreparationModesParamsQuery = <
      TData = GetBarcodesPreparationModesParamsQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables?: GetBarcodesPreparationModesParamsQueryVariables,
      options?: UseQueryOptions<GetBarcodesPreparationModesParamsQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<GetBarcodesPreparationModesParamsQuery, TError, TData>(
      variables === undefined ? ['getBarcodesPreparationModesParams'] : ['getBarcodesPreparationModesParams', variables],
      fetcher<GetBarcodesPreparationModesParamsQuery, GetBarcodesPreparationModesParamsQueryVariables>(client, GetBarcodesPreparationModesParamsDocument, variables, headers),
      options
    );
...
export const SimpleGetAllArticlesLusBarcodesDocument = `
    query SimpleGetAllArticlesLusBarcodes {
  stockOwners {
    results {
      id
      name
    ...
    `;
export const useSimpleGetAllArticlesLusBarcodesQuery = <
      TData = SimpleGetAllArticlesLusBarcodesQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables?: SimpleGetAllArticlesLusBarcodesQueryVariables,
      options?: UseQueryOptions<SimpleGetAllArticlesLusBarcodesQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<SimpleGetAllArticlesLusBarcodesQuery, TError, TData>(
      variables === undefined ? ['SimpleGetAllArticlesLusBarcodes'] : ['SimpleGetAllArticlesLusBarcodes', variables],
      fetcher<SimpleGetAllArticlesLusBarcodesQuery, SimpleGetAllArticlesLusBarcodesQueryVariables>(client, SimpleGetAllArticlesLusBarcodesDocument, variables, headers),
      options
    );
export const SimpleGetAllArticlesLusDocument = `
    query SimpleGetAllArticlesLus {
  articleLus {
    results {
      article {
        id
    ...
    `;
export const useSimpleGetAllArticlesLusQuery = <
      TData = SimpleGetAllArticlesLusQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables?: SimpleGetAllArticlesLusQueryVariables,
      options?: UseQueryOptions<SimpleGetAllArticlesLusQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<SimpleGetAllArticlesLusQuery, TError, TData>(
      variables === undefined ? ['SimpleGetAllArticlesLus'] : ['SimpleGetAllArticlesLus', variables],
      fetcher<SimpleGetAllArticlesLusQuery, SimpleGetAllArticlesLusQueryVariables>(client, SimpleGetAllArticlesLusDocument, variables, headers),
      options
    );
