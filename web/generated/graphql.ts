...
export type GetAllBarcodesQuery = { __typename?: 'Query', barcodes: { __typename?: 'BarcodeListResult', count: number, itemsPerPage: number, totalPages: number, results: Array<{ __typename?: 'Barcode', id?: number | null | undefined, accountId: number, companyId: number, articleId: number, name: string, rotation: string, preparationMode: number, flagDouble: number, supplierName?: string | null | undefined, supplierArticleCode?: string | null | undefined, quantity?: number | null | undefined }> } };
...
export type GetBarcodeByIdQuery = { __typename?: 'Query', barcode?: { __typename?: 'Barcode', id?: number | null | undefined, accountId: number, companyId: number, articleId: number, name: string, rotation: string, preparationMode: number, flagDouble: number, supplierName?: string | null | undefined, supplierArticleCode?: string | null | undefined, quantity?: number | null | undefined } | null | undefined };
