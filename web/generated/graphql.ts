...
export type CreateStockOwnerMutationVariables = Exact<{
  input: CreateStockOwnerInput;
}>;
...
export type DeleteStockOwnerMutation = { __typename?: 'Mutation', deleteStockOwner: boolean };

export type SoftDeleteStockOwnerMutationVariables = Exact<{
  stockOwnerId: Scalars['String'];
}>;


export type SoftDeleteStockOwnerMutation = { __typename?: 'Mutation', softDeleteStockOwner: boolean };

export type UpdateStockOwnerMutationVariables = Exact<{
  id: Scalars['String'];
  input: UpdateStockOwnerInput;
}>;
...
export type GetStockOwnersStatusesConfigsQuery = { __typename?: 'Query', listConfigsForAScope: Array<{ __typename?: 'ConfigResults', id: string, scope: string, code: string, text: string }> };
...
export const GetAllStockOwnersDocument = `
    query GetAllStockOwners($filters: StockOwnerSearchFilters, $orderBy: [StockOwnerOrderByCriterion!], $page: Int!, $itemsPerPage: Int!) {
  stockOwners(
    filters: $filters
    orderBy: $orderBy
    page: $page
...
export const GetStockOwnerByIdDocument = `
    query GetStockOwnerById($id: String!) {
  stockOwner(id: $id) {
    id
    name
    contact
    ...
    `;
export const useGetStockOwnerByIdQuery = <
      TData = GetStockOwnerByIdQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables: GetStockOwnerByIdQueryVariables,
      options?: UseQueryOptions<GetStockOwnerByIdQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<GetStockOwnerByIdQuery, TError, TData>(
      ['GetStockOwnerById', variables],
      fetcher<GetStockOwnerByIdQuery, GetStockOwnerByIdQueryVariables>(client, GetStockOwnerByIdDocument, variables, headers),
      options
    );
...
export const CreateStockOwnerDocument = `
  ...
  createStockOwner(input: $input) {
    ...
    `;
export const useCreateStockOwnerMutation = <
      TError = unknown,
      TContext = unknown
    >(
      client: GraphQLClient,
      options?: UseMutationOptions<CreateStockOwnerMutation, TError, CreateStockOwnerMutationVariables, TContext>,
      headers?: RequestInit['headers']
    ) =>
    useMutation<CreateStockOwnerMutation, TError, CreateStockOwnerMutationVariables, TContext>(
      ['CreateStockOwner'],
      (variables?: CreateStockOwnerMutationVariables) => fetcher<CreateStockOwnerMutation, CreateStockOwnerMutationVariables>(client, CreateStockOwnerDocument, variables, headers)(),
      options
    );
export const DeleteStockOwnerDocument = `
    mutation DeleteStockOwner($id: String!) {
  deleteStockOwner(id: $id)
}
    `;
export const useDeleteStockOwnerMutation = <
      TError = unknown,
      TContext = unknown
    >(
      client: GraphQLClient,
      options?: UseMutationOptions<DeleteStockOwnerMutation, TError, DeleteStockOwnerMutationVariables, TContext>,
      headers?: RequestInit['headers']
    ) =>
    useMutation<DeleteStockOwnerMutation, TError, DeleteStockOwnerMutationVariables, TContext>(
      ['DeleteStockOwner'],
      (variables?: DeleteStockOwnerMutationVariables) => fetcher<DeleteStockOwnerMutation, DeleteStockOwnerMutationVariables>(client, DeleteStockOwnerDocument, variables, headers)(),
      options
    );
export const SoftDeleteStockOwnerDocument = `
    mutation SoftDeleteStockOwner($stockOwnerId: String!) {
  softDeleteStockOwner(stockOwnerId: $stockOwnerId)
}
    `;
export const useSoftDeleteStockOwnerMutation = <
      TError = unknown,
      TContext = unknown
    >(
      client: GraphQLClient,
      options?: UseMutationOptions<SoftDeleteStockOwnerMutation, TError, SoftDeleteStockOwnerMutationVariables, TContext>,
      headers?: RequestInit['headers']
    ) =>
    useMutation<SoftDeleteStockOwnerMutation, TError, SoftDeleteStockOwnerMutationVariables, TContext>(
      ['SoftDeleteStockOwner'],
      (variables?: SoftDeleteStockOwnerMutationVariables) => fetcher<SoftDeleteStockOwnerMutation, SoftDeleteStockOwnerMutationVariables>(client, SoftDeleteStockOwnerDocument, variables, headers)(),
      options
    );
export const UpdateStockOwnerDocument = `
    mutation UpdateStockOwner($id: String!, $input: UpdateStockOwnerInput!) {
  updateStockOwner(id: $id, input: $input) {
    ...
    `;
export const useUpdateStockOwnerMutation = <
      TError = unknown,
      TContext = unknown
    >(
      client: GraphQLClient,
      options?: UseMutationOptions<UpdateStockOwnerMutation, TError, UpdateStockOwnerMutationVariables, TContext>,
      headers?: RequestInit['headers']
    ) =>
    useMutation<UpdateStockOwnerMutation, TError, UpdateStockOwnerMutationVariables, TContext>(
      ['UpdateStockOwner'],
      (variables?: UpdateStockOwnerMutationVariables) => fetcher<UpdateStockOwnerMutation, UpdateStockOwnerMutationVariables>(client, UpdateStockOwnerDocument, variables, headers)(),
      options
    );
export const GetStockOwnersStatusesConfigsDocument = `
    query getStockOwnersStatusesConfigs {
  listConfigsForAScope(scope: "stock_owner_status") {
    id
    scope
    code
    text
    ...
    `;
export const useGetStockOwnersStatusesConfigsQuery = <
      TData = GetStockOwnersStatusesConfigsQuery,
      TError = unknown
    >(
      client: GraphQLClient,
      variables?: GetStockOwnersStatusesConfigsQueryVariables,
      options?: UseQueryOptions<GetStockOwnersStatusesConfigsQuery, TError, TData>,
      headers?: RequestInit['headers']
    ) =>
    useQuery<GetStockOwnersStatusesConfigsQuery, TError, TData>(
      variables === undefined ? ['getStockOwnersStatusesConfigs'] : ['getStockOwnersStatusesConfigs', variables],
      fetcher<GetStockOwnersStatusesConfigsQuery, GetStockOwnersStatusesConfigsQueryVariables>(client, GetStockOwnersStatusesConfigsDocument, variables, headers),
      options
    );
