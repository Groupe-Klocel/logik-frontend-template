...
export type RenderBarcodeMutation = {
    __typename?: 'Mutation';
    renderBarcode:
        | { __typename: 'BarcodeError'; message: string }
...
export const RenderBarcodeDocument = `
  ...
  renderBarcode(code: $code, category: $category, pages: $pages) {
    ...
    `;
export const useRenderBarcodeMutation = <TError = unknown, TContext = unknown>(
    client: GraphQLClient,
    options?: UseMutationOptions<
    ...
    useMutation<RenderBarcodeMutation, TError, RenderBarcodeMutationVariables, TContext>(
        ['RenderBarcode'],
        (variables?: RenderBarcodeMutationVariables) =>
            fetcher<RenderBarcodeMutation, RenderBarcodeMutationVariables>(
                client,
                RenderBarcodeDocument,
                variables,
                headers
            )(),
        options
